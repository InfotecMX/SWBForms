...
swbf.dataStores["mongodb"].port=27018;
        ...
        {name: "area", title: "Area", required: true, type: "string",validators: [
            {
                ...
                serverCondition:function(name,value,request){              
                    //print(sengine.getDataSource("Pais").fetch().response.data[0].nombre);
                    return value=="jei 3";
                },
...
swbf.dataServices["PaisService"] = {
    ...
    service: function(request, response, dataSource, action)
    {
        ...
        //print("user:"+sengine.getUser());
        //print(sengine.getDataSource("Pais").fetchObjById("_suri:VINDB:Pais:53ca73153004aec988f550e2").nombre);
        //print(sengine.getDataSource("Pais").fetch("{data:{abre : 'MX'}}"));
        //print(sengine.getDataSource("Pais").fetch());
        //print(sengine.getDataSource("Pais").fetch().response.data[0].nombre);
    }
};
